<x-layouts.layout>
    ...
    <form class="flex justify-center h-full items-center" method="post" action="/alumnos/{{$alumno->id}}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="bg-white p-5 rounded-2xl">
            ...
            <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <a type="button" class="text-sm font-semibold leading-6 text-gray-900" href="/alumnos">Volver al Listado</a>
                <button type="submit"
